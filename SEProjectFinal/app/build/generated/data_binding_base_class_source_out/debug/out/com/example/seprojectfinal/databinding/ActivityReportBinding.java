...
public final class ActivityReportBinding implements ViewBinding {
  ...
  private ActivityReportBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonReport,
      @NonNull EditText editTextReport, @NonNull TextView textView) {
  ...
  public static ActivityReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityReportBinding((ConstraintLayout) rootView, buttonReport, editTextReport,
          textView);
    }
